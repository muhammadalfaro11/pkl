...
class Admin extends CI_Controller
{
    ...
    {
        $this->email->from('umusbrebes@gmail.com', 'Universitas Stikubank Semarang');
        $this->email->to($email);

        $this->email->subject('Sistem Informasi Skripsi');
        $this->email->message('Selamat Datang ' . $nama . ' di Universitas Stikubank Semarang. Sekarang anda bisa login sistem informasi skripsi dengan menggunakan ID anda. Password : ' . $password . '  Semoga harimu menyenangkan.');
